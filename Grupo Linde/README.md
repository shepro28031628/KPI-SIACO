...
Para alimentar la base de datos local de la Torre de Control, arrastra o selecciona los **2 reportes madre** exportados desde tu sistema:

1. 📄 `REPORTE.xlsx` *(o xls)*
2. 📄 `ahorro arancel.xlsx` *(o xls)*
